...
/***/ function(module, exports, __webpack_require__) {
	...
	var conditions = [0, 100, 200, 300];
	var data = [16, 31, 56, 45, 15, 29, 31, 35, 18, 15, 25, 21, 8, 12, 18, 15];
	
	var myANOVA = new _anova2.default(data, conditions, 'ms', 'nausia');
	
	(0, _utils.printDataTable)(myANOVA);
	
	document.write('<table border="1" cellspacing="0" cellpadding="5" class="col1-bold"><tbody>');
	(0, _utils.tr)('Subject totals', myANOVA.getSubjectTotals());
	(0, _utils.tr)('Condition totals', myANOVA.getConditionTotals());
	(0, _utils.tr)('Subject means', myANOVA.getSubjectMeans());
	(0, _utils.tr)('Condition means', myANOVA.getConditionMeans());
	(0, _utils.tr)('Grand mean', myANOVA.getGrandMean());
	(0, _utils.tr)('Sum of sqaures Total', myANOVA.getSumOfSquaresTotal());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stat_utils = __webpack_require__(3);
	...
	var ANOVA = function () {
	  ...
	  */
		...
		function ANOVA() {
			...
			var conditionMeasurement = arguments.length <= 2 || arguments[2] === undefined ? '' : arguments[2];
			var subjectMeasurement = arguments.length <= 3 || arguments[3] === undefined ? '' : arguments[3];
		...
		_createClass(ANOVA, [{
			...
			value: function getCriticalF() {
				...
				var critF = (0, _stat_utils.fdistr)(dfNumerator, dfDenominator, level);
				return critF;
			}
		}, {
			...
			value: function getUpperProbabilityOfF() {
				...
				var P = (0, _stat_utils.fprob)(dfNumerator, dfDenominator, F / 10);
				return P;
			}
		}]);
...
/***/ function(module, exports) {
	...
	var SIGNIFICANT = 16; // number of significant digits to be returned
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Graph = function () {
		function Graph(_settings) {
			_classCallCheck(this, Graph);
	
			var settings = Object.assign({}, defaultSettings, _settings);
		...
		_createClass(Graph, [{
			...
			value: function generateData() {
				...
				var _ANOVA = this.ANOVA;
				var data = _ANOVA.data;
				var conditions = _ANOVA.conditions;
				var conditionMeasurement = _ANOVA.conditionMeasurement;
			...
			key: 'createGraphInstance',
			value: function createGraphInstance() {
				var _ANOVA2 = this.ANOVA;
				var data = _ANOVA2.data;
				var subjectMeasurement = _ANOVA2.subjectMeasurement;
				var conditionMeasurement = _ANOVA2.conditionMeasurement;
			}
		}]);
...
/***/ function(module, exports) {
	...
	exports.pr = pr;
	exports.tr = tr;
	exports.printDataTable = printDataTable;
	function pr(bold, text) {
	...
	function printDataTable(ANOVA) {
		var data = ANOVA.data;
		var conditions = ANOVA.conditions;
		var subjectMeasurement = ANOVA.subjectMeasurement;
		var conditionMeasurement = ANOVA.conditionMeasurement;
		var subjects = ANOVA.subjects;
		...
		for (var s = 0; s < subjects; s++) {
			...
			for (var c = 0; c < conditions.length; c++) {
				var observation = data[s * conditions.length + c];
